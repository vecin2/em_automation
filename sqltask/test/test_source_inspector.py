import inspect
import sqltask.test.utils.package_example as package_example
import sqltask.test.utils.package_example.module_example as module_example
from sqltask.test.utils.package_example.module_example import (
    example_filter1 as example_filter1,
)
from sqltask.test.utils.package_example.module_example2 import (
    example_filter2 as example_filter2,
)
import sqltask.docugen.source_inspector as source_inspector
import pkgutil
...
def test_get_modules_import_path_from_package():
    ...
    assert "sqltask.test.utils.package_example.module_example" == modules[0]
    assert "sqltask.test.utils.package_example.module_example2" == modules[1]
