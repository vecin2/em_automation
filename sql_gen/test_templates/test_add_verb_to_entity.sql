--["PCCustomerInlineEdit","PCCustomer.Verbs.CustomerInlineEdit","NULL","0","en-US","inlineEdit","Customer","Y","N","Y","Inline Edit"]
...
INSERT INTO LOCALISED_FIELD (OBJECT_TYPE, OBJECT_INSTANCE, OBJECT_VERSION, FIELD_NAME, LOCALE, LOOKUP_LOCALE,TEXT,IS_DELETED) VALUES (
'VerbED',-- OBJECT_TYPE
'CustomerED__PCCustomerInlineEdit',-- OBJECT_INSTANCE
