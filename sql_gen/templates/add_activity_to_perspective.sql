{% set perspective_ids = _keynames.CC %} 
{% set entity_types = _keynames.ET %} 
{% set entity_type_tmp = entity_type | suggest(entity_types) %}
...
VALUES (
	 @CC.{{perspective_id | suggest(perspective_ids) }},--config_id
