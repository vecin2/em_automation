...
SET (LOGICAL_OBJ_PATH, INTERFACE_PATH, SUPER_ENTITY_DEFINITION, SUPER_ENTITY_DEFINITION_ENV_ID) = ('{{base_entity["LOGICAL_OBJ_PATH"]}}', '{{base_entity["INTERFACE_PATH"]}}', {{_keynames.get_full("ED",base_entity["SUPER_ENTITY_DEFINITION"]) }}, @ENV.Dflt) 
