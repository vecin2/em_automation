...
After he the values entered are used to render the template generating a final SQL script, which is then send to the corresponding output.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDYyMTg1MDEsLTE4ODQxMTI0MjRdfQ
==
-->