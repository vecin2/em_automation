...
After he user enters the values sqltask renders the templatendered and it generates the final SQL script, which can be either printed, saved as an SQL task or run in the database.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjA1MTQ2MDIsLTE5NjcyNDcxMTBdfQ
==
-->